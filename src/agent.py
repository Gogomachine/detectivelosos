...
class CaseWalkerAgent:
    ...
    async def start(self):
        ...
        self.scheduler.set_callbacks(
            ...
            on_goodnight=self.generate_and_publish_goodnight_post,
        )
    ...
    async def generate_and_publish_goodnight_post(self, tip_topic: str):
        """Generate and publish a goodnight post with a security tip."""
        used_topics = await self.db.get_used_topics("goodnight")
        ...
        if message_id:
            await self.db.update_post_status(post_id, "published", message_id)
            await self.db.save_used_topic(tip_topic, "goodnight")
